...
const EditFeedbackModal = ({employeesList, onEditFeedback}) => {
  ...
  const onEditBtnClick = () => {
    onEditFeedback(feedbackContributorDetails.employeeId, feedbackReceiversDetails.employeeId, feedback)
  }
  ...
  return (
    <Modal.Dialog>
      ...
      <Modal.Footer>
        ...
        <Button variant="primary" onClick={onEditBtnClick}>Edit Feedback</Button>
      </Modal.Footer>
    </Modal.Dialog>
  )
}
